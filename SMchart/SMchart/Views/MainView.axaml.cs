...
{ ""From"": 6, ""To"": 8, ""Dir"": 2 }
        ...
        private void Setup()
        {
            ...
            _Diagram.ToolManager.ClickCreatingTool.ArchetypeNodeData =
                new NodeData {Text = "NEW NODE"}; // create a new node by double-clicking in background
            ...
            _Diagram.NodeTemplate =
                new Node("Auto")
                    ...
                    .Bind(
                        ...
                        new Binding("DesiredSize", "Size", Northwoods.Go.Size.Parse).MakeTwoWay(Northwoods.Go.Size
                            .Stringify)
                    )
                    .Add(
                        new Shape
                        ...
                        new TextBlock
                            {
                                Margin = 1, TextAlign = TextAlign.Center, Overflow = Overflow.Ellipsis, Editable = true
                            }
                            .Bind(
            ...
            Shape MakeArrowButton(Spot spot, string fig)
            {
                void maker(InputEvent e, GraphObject shape)
                {
                    ...
                    e.Diagram.Model.Commit((m) =>
                    {
                        ...
                        Task.Delay(20).ContinueWith((t) => { e.Diagram.CommandHandler.EditTextBlock(); });
                    });
                }
                ...
                return Builder.Make<Panel>("ContextMenuButton")
                    .Add(
                        new Panel("Horizontal")
                            .Add(ColorButton("white", "Fill"), ColorButton("beige", "Fill"),
                                ColorButton("aliceblue", "Fill"), ColorButton("lightyellow", "Fill"))
                    );
            }
            ...
            GraphObject LightFillButton2()
            {
                return Builder.Make<Panel>("ContextMenuButton")
                    .Add(
                        new Panel("Horizontal")
                            .Add(ColorButton("lightgray", "Fill"), ColorButton("lightgreen", "Fill"),
                                ColorButton("lightblue", "Fill"), ColorButton("pink", "Fill")
                            )
                    );
            }
            ...
            GraphObject DarkColorButton2()
            {
                return Builder.Make<Panel>("ContextMenuButton")
                    .Add(
                        new Panel("Horizontal")
                            .Add(ColorButton("brown"), ColorButton("magenta"), ColorButton("purple"),
                                ColorButton("orange"))
                    );
            }
            ...
            Shape FigureButton(string fig, string propname = "Figure")
            {
                return new Shape
                {
                    ...
                    Margin = 1, Background = "transparent",
                    MouseEnter = (InputEvent e, GraphObject shape, GraphObject obj) =>
                    {
                        (shape as Shape).Fill = "dodgerblue";
                    },
                    MouseLeave = (InputEvent e, GraphObject shape, GraphObject obj) =>
                    {
                ...
                Builder.Make<Adornment>("ContextMenu")
                    .Add(
                        Builder.Make<Panel>("ContextMenuButton")
                            .Add(
                                new Panel("Horizontal")
                                    .Add(FigureButton("Rectangle"), FigureButton("RoundedRectangle"),
                                        FigureButton("Ellipse"), FigureButton("Diamond"))
                            ),
                        Builder.Make<Panel>("ContextMenuButton")
                            .Add(
                                new Panel("Horizontal")
                                    .Add(FigureButton("Parallelogram2"), FigureButton("ManualOperation"),
                                        FigureButton("Procedure"), FigureButton("Cylinder1"))
                            ),
                        Builder.Make<Panel>("ContextMenuButton")
                            .Add(
                                new Panel("Horizontal")
                                    .Add(FigureButton("Terminator"), FigureButton("CreateRequest"),
                                        FigureButton("Document"), FigureButton("TriangleDown"))
                            ),
                        LightFillButton1(),
                        LightFillButton2(),
                        DarkColorButton1(),
                        ...
                        new TextBlock
                            {
                                ...
                                Font = new Font("Microsoft Sans Serif", 12, Northwoods.Go.FontWeight.Bold,
                                    FontUnit.Point),
                                Editable = true
                            }
                            .Bind(
                ...
                new Link
                    {
                        ...
                        ToShortLength =
                            4, // assume arrowhead at "to" end, need to avoid bad appearance when path is thick
            ...
            Shape SpotButton(Spot spot, bool to)
            {
                ...
                if (spot.Equals(Spot.Top))
                {
                    ang = 270;
                    side = Spot.TopSide;
                }
                else if (spot.Equals(Spot.Left))
                {
                    ang = 180;
                    side = Spot.LeftSide;
                }
                else if (spot.Equals(Spot.Bottom))
                {
                    ang = 90;
                                    ...
                                    .Add(
                                        new Panel(PanelType.Spot)
                                            .Add(
                                                ...
                                                SpotButton(Spot.Top, false), SpotButton(Spot.Left, false),
                                                SpotButton(Spot.Right, false), SpotButton(Spot.Bottom, false)
                                            ),
                                        new Panel(PanelType.Spot) {Margin = new Margin(0, 0, 0, 2)}
                                            .Add(
                                                AllSidesButton(true),
                                                SpotButton(Spot.Top, true), SpotButton(Spot.Left, true),
                                                SpotButton(Spot.Right, true), SpotButton(Spot.Bottom, true)
                                            )
                                    )
                            )
                    );
        ...
        private void SaveModel()
        {
            ...
            JsonText = _Diagram.Model.ToJson();
        }

        private void LoadModel()
        {
            if (_Diagram == null) return;
            _Diagram.Model = Model.FromJson<Model>(JsonText);
